...
public class RetryAnalyzer implements IRetryAnalyzer {
	...
	/*	 All tests that are retried after failures will appear in the skipped tests list.
         Which causes TestNg to report those retry attempts as skipped tests.
		 ...
		 The line below simply does help . Retried tests still marked as ignored.*/
